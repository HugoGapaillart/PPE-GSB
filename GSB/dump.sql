...
#
# OPTIONS:
#   sourcefilename=G:\PPE GSB\Document etudiant\Swiss_Visite.mdb
#   sourceusername=
#   sourcepassword=
...
CREATE TABLE `INVITER` (
  ...
  `SPECIALISTEON` TINYINT(1) DEFAULT 0, 
...
INSERT INTO `OFFRIR` (`VIS_MATRICULE`, `RAP_NUM`, `MED_DEPOTLEGAL`, `OFF_QTE`) VALUES ('zzz', 12, 'ADIMOL9', 12);
INSERT INTO `OFFRIR` (`VIS_MATRICULE`, `RAP_NUM`, `MED_DEPOTLEGAL`, `OFF_QTE`) VALUES ('zzz', 12, '3MYC7', 1);
# 4 records
...
INSERT INTO `RAPPORT_VISITE` (`VIS_MATRICULE`, `RAP_NUM`, `PRA_NUM`, `RAP_DATE`, `RAP_BILAN`, `RAP_MOTIF`) VALUES ('zzz', 12, 82, '2020-03-06 00:00:00', 'Tumeur apparu depusi le 8 décembre 1995, c\'est transformé en Cancer du crane il y a deux semaines.', 'Cancer du crane');
# 4 records
